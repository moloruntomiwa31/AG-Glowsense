<template>
    <div class="flex flex-col justify-center items-center min-h-[90vh] logIn">
        <h1 class="text-4xl font-bold text-white">Log in</h1>
        <RegisterForm @submitForm="submitForm" :buttonText="buttonText"/>
        <p class="text-white md:text-xl my-3">Don't have an account? <RouterLink to="/signup" class="underline text-red-300">Sign Up</RouterLink></p>
